                ...
                <Modal isOpen={this.state.modalIsOpen} onRequestClose={this.closeModal} contentLabel="Add Expense" className="Modal">
                  ...
                  <fieldset>
                    ...
                    <select id="year" name="year" value={this.state.year} onChange={this.handleSelectChange}>
                      <option value="2019" id="17">2019</option>
                      <option value="2020" id="17">2020</option>
                      <option value="2021" id="17">2021</option>
                      <option value="2022" id="18">2022</option>
                      <option value="2023" id="19">2023</option>
                    </select>
                  </fieldset>
